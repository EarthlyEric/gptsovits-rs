...
- **V2 / V2Pro / V2ProPlus**: 符號集 `symbols_v2` (732 符號)，輸出 32,000 Hz。
- **V3**: 符號集 `symbols_v2` (732 符號)，輸出 24,000 Hz。
- **V4**: 符號集 `symbols_v2` (732 符號)，輸出 48,000 Hz。
...
### 3.5 Docker 容器化部署
```bash
# 使用 Docker Compose 啟動 (內建 CUDA 13/cuDNN GPU 加速)
